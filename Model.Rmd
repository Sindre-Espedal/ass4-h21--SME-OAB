...
Lager ny variabel (*aar_d*) i **coef_df**:

```{r}
# Er nok feil -> Må fikses opp i.
coef_df <- mod_sum %>%
  mutate(aar = make_date(aar_d))
```
...
iii. Lag så et plot av fylke-faktorvariablenes koeffisienter for fylkene “fnr02”, “fnr03”, “fnr04”, “fnr10”,
“fnr11”, “fnr12”, “fnr14” fra år 2008 til 2017.
