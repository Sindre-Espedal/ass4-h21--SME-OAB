...
Lager nye variabler for kvinner og menn sammenlagt (Total_t) v.h.a mutate funksjonen:
...
i. Slår sammen *pop_08_17_ya* og *pop_08_17_ya* og legger det inn i *pop_08_17_ya_p*:

```{r}
pop_08_17_ya_p <- merge(pop_08_17, pop_08_17_ya)
```

ii. Beregner prosentandel av yrkesaktiv alder for kvinner  (Kvinner_ya_p), menn (Menn_ya_p) og totalt
(Total_ya_p).
...
Det er et aller annet med **dim** her som ikke er som du vil det skal være..
